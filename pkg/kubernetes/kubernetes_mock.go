...
// Package inspection is a generated GoMock package.
package kubernetes
...
func (m *MockClient) List(ctx context.Context, list client.ObjectList, opts ...client.ListOption) error {
	...
	if codeRepoList, ok := list.(*resourcev1alpha1.CodeRepoList); ok {
		codeRepoList.Items = append(codeRepoList.Items, resourcev1alpha1.CodeRepo{
			ObjectMeta: v1.ObjectMeta{Name: "repo-22"},
		})
	}
	ret := m.ctrl.Call(m, "List", varargs...)
	ret0, _ := ret[0].(error)
